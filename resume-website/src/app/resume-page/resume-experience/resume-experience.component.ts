...
export class ResumeExperienceComponent implements OnInit {
  ...
  ngOnInit() {
    const uottawaCard = new Card('University of Ottawa',
     ...
     'Enrolled at uOttawa Software Engineering in 2017, and currently undergoing fourth study term. My phenomenal professors are ' +
     'pushing me to be more innovative and become a better problem solver. My experience on the uOttawa GeeGees Ultimate Frisbee Team ' +
    ...
    ' which is much more in depth and fleshed out then I once thought. JSI is a customer-driven company, I experienced' +
    ' a culture which was welcoming to new customers and dependable to old customers, showing me that empathy and understanding' +
