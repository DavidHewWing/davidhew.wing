...
export class ResumeExperienceComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    ' which is much more in depth and though out then I once thought it was. JSI was a customer-driven company, I experienced' +
    ...
    ' their day to share their knowledge. My co-workers enabled my confidence to develop quality software to grow.' +
