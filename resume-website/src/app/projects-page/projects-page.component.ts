...
export class ProjectsPageComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    const safeChat = new Project('Safe Chat', 'A potential chat-room platform, that filters out toxic/bad words ' +
    'allowing people to improve their online experience. A potential use is in many MMORPG, or online games, in which ' +
    'many players can be banned for being toxic. Worked on at a Hackathon with "Derek Shao", "Thomas Leung" and "Kyle Pinkerton"',
    ...
    'October 2018 - November 2018'
     ...
     'Rodin Habib, Aadithya Shankar and I work on this. It was our take on "Zork: A Text Based Adventure". Was made in pure Java ' +
     'and for pure fun. This project made me fall in love with programming.',
